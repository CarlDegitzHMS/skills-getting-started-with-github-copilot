...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis skills and tournament preparation",
    ...
    "Music Ensemble": {
        "description": "Learn instruments and perform in ensemble productions",
    ...
    "Science Olympiad": {
        "description": "Compete in science challenges and national competitions",
